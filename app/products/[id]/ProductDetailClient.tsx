                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-start justify-between">
                            <div className="space-y-2">
                                <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-black wrap-break-word">
                                    {product.name}
                                </h1>
                        ...
                        <div className="border-t border-neutral-200 pt-8 mt-8">
                            ...
                            <p className="text-xl text-neutral-600 leading-relaxed wrap-break-word">
                                {product.description}
                            </p>
                        </div>
